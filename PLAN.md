...
Built 2026-07-28. The mark and its server-side application still stand for the doc editor;
the reading views stopped writing marks with §13o (2026-08-13), and the shared `Comment*`
components were un-shared by §13c the next day. **As built: [docs/ANNOTATIONS.md](docs/ANNOTATIONS.md)**,
"Anchoring" and "Decisions". The plan text is in the parent of the commit that introduced this stub.

### 12j. `/annotations`

Built with §12; a Container column and file rows since §19. **As built:
[docs/ANNOTATIONS.md](docs/ANNOTATIONS.md)**, "Surfaces" and, for the readability-not-manageability
scope, "Decisions". The plan text is in the parent of the commit that introduced this stub.
