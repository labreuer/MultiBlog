...
effect of adding the tag models (PLAN.md §20), where 249 of 399 changed lines were
whitespace and `git blame` on them pointed at a commit about tags. The reformat was split
